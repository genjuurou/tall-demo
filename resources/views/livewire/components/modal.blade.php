...
>
    <div @click.outside="$wire.close()" class="w-full max-w-xl px-6 py-4 m-4 overflow-hidden rounded-lg text-sm bg-white text-gray-700 dark:text-gray-400 dark:bg-zinc-800" role="dialog">
        @if ($component)    
